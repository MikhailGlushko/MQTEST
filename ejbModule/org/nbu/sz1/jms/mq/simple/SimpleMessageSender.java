...
public class SimpleMessageSender implements MessageSender{
     ...
     */
    @Deprecated
    public void sendMessage(String message) throws JMSRuntimeException, JMSParameterIsNullException {
    	if(Objects.isNull(message))
    		throw new JMSParameterIsNullException("Parameter message is NULL");
    	
        context.createProducer().send(inboundQueue, message);
    }
    ...
    public void sendMessage(String queueName, String message) throws JMSRuntimeException, NamingException, JMSParameterIsNullException {
    	if(Objects.isNull(message))
    		throw new JMSParameterIsNullException("Parameter message is NULL");
    	...
    	Queue syncQueue = (Queue) ctx_q.lookup(queueName);
     ...
     */
    @SuppressWarnings("deprecation")
	public void sendMessage(String queueMamagerName, String queueName, String message) throws JMSRuntimeException, NamingException, JMSParameterIsNullException{
    	if(Objects.isNull(message))
    		throw new JMSParameterIsNullException("Parameter message is NULL");
    	if(Objects.isNull(queueName))
    		throw new JMSParameterIsNullException("Parameter queueName is NULL");
